      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-2 md:grid-cols-6 gap-12 text-left">
        ...
        <div className="col-span-2 space-y-4">
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <circle
                ...
                strokeWidth="1"
                opacity="0.25"
                className="logo-spin-slow-reverse"
              />
              <circle
                cx="50"
                cy="50"
          ...
          <p className="text-xs text-[#172B36]/60 leading-relaxed font-sans max-w-xs">
            Autonomous data processing networks and distributed schema alignment
            pipelines built for high-performance software architecture.
          </p>
        ...
        <div className="space-y-3 font-mono text-xs">
          <h4 className="text-[10px] uppercase text-[#172B36]/50 tracking-widest font-bold">
            System
          </h4>
