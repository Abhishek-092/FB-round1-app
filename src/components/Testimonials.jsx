...
export default function Testimonials() {
  return (
    <section id="testimonials" className="py-24 md:py-36 bg-[#F1F6F4] border-b border-[#D9E8E2]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 text-left">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between p-8 md:p-12 border border-[#114C5A] bg-[#D9E8E2]/20">
            ...
            <div className="mt-12 pt-8 border-t border-[#D9E8E2] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <div className="font-bold text-[#114C5A] text-sm">{LOGS[0].author}</div>
                <div className="text-xs text-[#172B36]/60">{LOGS[0].title}, {LOGS[0].company}</div>
              </div>
              <div className="font-mono text-right sm:text-left">
                ...
                <span className="text-xs font-bold text-[#114C5A]">{LOGS[0].stats}</span>
              </div>
            </div>
          </div>
